  ...
  <div class="friends_list" :class="state">
    ...
    <div class="pl-2 pr-2">
      ...
      <ul class="friends_list_ul" v-show="selected === 'friends'">
        ...
        <div class="text-center mt-3" v-if="!loading" v-show="friends.length === 0">
          No theater followed yet!
        </div>

        <!-- Online Friends -->
        <TheaterRow ref="friends" :key="friend.id" v-for="friend in orderedFriends" :friend="friend" />
